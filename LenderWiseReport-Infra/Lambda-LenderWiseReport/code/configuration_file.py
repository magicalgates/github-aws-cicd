...
db_file_path = 'Bills/May/DB_Report.xlsx'
s3_report_file_path = 'Bills/May/s3 bucket storage count.xlsx'
service_cost_file_path = 'Bills/May/436415935402_NDS_Systems.xlsx'
Lender_waf_report_file_path = 'Bills/May/waf-report.xlsx'
generic_report_file_path = 'Bills/May/NDS_Systems_Generic_LenderWiseCost_Report.xlsx'